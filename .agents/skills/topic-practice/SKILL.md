...
- Treat connecting words and embedded clauses as grammar, not just vocabulary. Build their allowlist from `grammar/`. Currently, use only **and**, **but**, and **because** to join ideas, plus relative **who** for people and **that** for animals or things. Do not use other clause introducers such as **so**, **if**, **when**, **after**, **before**, **where**, **what**, **why**, **how**, or **although** unless the grammar files later teach them.
